...
static_assert(std::is_nothrow_constructible_v<seastar::ipv4_addr>);
static_assert(std::is_nothrow_copy_constructible_v<seastar::ipv4_addr>);
static_assert(std::is_nothrow_move_constructible_v<seastar::ipv4_addr>);

static_assert(std::is_nothrow_constructible_v<seastar::ipv6_addr>);
static_assert(std::is_nothrow_copy_constructible_v<seastar::ipv6_addr>);
static_assert(std::is_nothrow_move_constructible_v<seastar::ipv6_addr>);

static_assert(std::is_nothrow_constructible_v<seastar::net::inet_address>);
