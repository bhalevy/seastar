...
static_assert(std::is_nothrow_constructible_v<connected_socket>);
static_assert(std::is_nothrow_move_constructible_v<connected_socket>);

static_assert(std::is_nothrow_constructible_v<socket>);
static_assert(std::is_nothrow_move_constructible_v<socket>);

static_assert(std::is_nothrow_constructible_v<server_socket>);
