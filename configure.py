...
arg_parser.add_argument('--require-continuations-nothrow-move-constructible',
                        dest='require_continuations_nothrow_move_constructible',
                        action='store_true',
                        help='require continuation functions to be nothrow_move_constructible')
...
def configure_mode(mode):
    ...
    TRANSLATED_ARGS = [
        ...
        tr(args.require_continuations_nothrow_move_constructible, 'CONTINUATIONS_NOTHROW_MOVE_CONSTRUCTIBLE'),
    ]
