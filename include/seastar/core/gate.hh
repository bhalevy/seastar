...
#ifdef GATE_HOLDER_DEBUG
    size_t _holders = 0;

    void assert_not_held(const gate& g) const noexcept {
        assert(!g._holders && "gate moved with outstanding holders");
    }
#else   // GATE_HOLDER_DEBUG
    void assert_not_held(const gate& g) const noexcept {}
#endif  // GATE_HOLDER_DEBUG
