...
public:
    abort_on_both() = default;
    abort_on_both(seastar::abort_source& as0, seastar::abort_source& as1) noexcept
        : _as0(&as0)
        , _as1(&as1)
    {
        do_subscribe();
    }
    abort_on_both(abort_on_both&& o) noexcept
        : _as0(std::exchange(o._as0, nullptr))
        , _as1(std::exchange(o._as1, nullptr))
    ...
    abort_on_both& operator=(abort_on_both&& o) noexcept {
        if (this != &o) {
            _as0 = std::exchange(o._as0, nullptr);
            _as1 = std::exchange(o._as1, nullptr);
            _aborted = std::exchange(o._aborted, 0);
