...
with_shared_impl(shared_mutex& sm, Func&& func) noexcept(std::is_nothrow_move_constructible<Func>::value) {
...
inline
futurize_t<std::result_of_t<Func ()>>
with_lock_impl(shared_mutex& sm, Func&& func) noexcept(std::is_nothrow_move_constructible<Func>::value) {
