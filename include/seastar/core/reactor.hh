...
private:
    ...
    future<struct stat> fstat(int fd);
    future<struct statfs> fstatfs(int fd);
    friend future<shared_ptr<file_impl>> make_file_impl(int fd, file_open_options options, int flags);
public:
