...
public:
    ...
    future<> create(const compat::filesystem::path path_template = default_tmp_path,
...
///    The parent directory must exist and be writable to the current process.
///
future<tmp_dir> make_tmp_dir(const compat::filesystem::path path_template = default_tmp_path,
        file_permissions create_permissions = file_permissions::default_dir_permissions);
