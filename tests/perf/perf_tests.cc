...
static constexpr auto header_format_string = "{:<40} {:>11} {:>11} {:>11} {:>11} {:>11} {:>11} {:>11} {:>11} {:>11}\n";
static constexpr auto        format_string = "{:<40} {:>11} {:>11} {:>11} {:>11} {:>11} {:>11} {:>11.3f} {:>11.3f} {:>11.1f}\n";
...
struct stdout_printer final : result_printer {
  virtual void print_configuration(const config& c) override {
    ...
    fmt::print(header_format_string, "test", "iterations", "norm_factor", "median", "mad", "min", "max", "allocs", "tasks", "inst");
  }
    ...
    for (auto i = 0u; i < conf.number_of_runs; i++) {
        ...
        yield().then([&] {
            ...
            return do_single_run().then([&] (run_result rr) {
                ...
                r.allocs += (double(rr.stats.allocations) / _single_run_iterations) / _norm_factor;
                r.tasks += (double(rr.stats.tasks_executed) / _single_run_iterations) / _norm_factor;
                r.inst += (double(rr.stats.instructions_retired) / _single_run_iterations) / _norm_factor;
