...
SEASTAR_THREAD_TEST_CASE(test_abort_on_either_already_aborted) {
    std::default_random_engine random_engine(testing::local_random_engine());
    std::uniform_int_distribution<> dist(0, 1);
    std::array<abort_source, 2> ass;
...
SEASTAR_THREAD_TEST_CASE(test_abort_on_either_move) {
    std::default_random_engine random_engine(testing::local_random_engine());
    std::uniform_int_distribution<> dist(0, 1);
    std::array<abort_source, 2> ass;
    auto awe0 = abort_on_either(ass[0], ass[1]);
...
SEASTAR_THREAD_TEST_CASE(test_abort_on_both) {
    std::default_random_engine random_engine(testing::local_random_engine());
    std::uniform_int_distribution<> dist(0, 1);
    std::array<abort_source, 2> ass;
    auto awb = abort_on_both(ass[0], ass[1]);
...
SEASTAR_THREAD_TEST_CASE(test_abort_on_both_already_aborted_once) {
    std::default_random_engine random_engine(testing::local_random_engine());
    std::uniform_int_distribution<> dist(0, 1);
    std::array<abort_source, 2> ass;
...
SEASTAR_THREAD_TEST_CASE(test_abort_on_both_already_aborted_twice) {
    std::default_random_engine random_engine(testing::local_random_engine());
    std::uniform_int_distribution<> dist(0, 1);
    std::array<abort_source, 2> ass;
...
SEASTAR_THREAD_TEST_CASE(test_abort_on_both_move) {
    std::default_random_engine random_engine(testing::local_random_engine());
    std::uniform_int_distribution<> dist(0, 1);
    std::array<abort_source, 2> ass;
    auto awb0 = abort_on_both(ass[0], ass[1]);
